...
import {
  CrmKanbanBoard,
  type CrmColumn,
} from "@/components/nova/kanban-crm";
import { ChatPanel } from "@/components/nova/chat-panel";

const crmTabs = [
  { id: "open", label: "Abertos", count: 16, tone: "primary" as const },
  { id: "won", label: "Ganhos", count: 8, tone: "success" as const },
  { id: "lost", label: "Perdidos", count: 3, tone: "destructive" as const },
  { id: "all", label: "Todos", count: 27, tone: "muted" as const },
];
    ...
    cards: [
      {
        ...
        initials: "DA",
        channel: "whatsapp",
        title: "Curso de IA — Turma Q2",
        age: "20 dias",
        product: "Administração EAD",
        value: "R$ 119,00",
        tag: { label: "Em Curso", tone: "cyan" },
        owner: { name: "Admin EduIT", initials: "AE", online: true },
        accent: "amber",
      },
      {
        id: "q2",
        ref: "#30",
        date: "18/04/2026",
        contact: "Henrique Lima",
        initials: "HL",
        channel: "whatsapp",
        title: "Escalabilidade B2B",
        age: "20 dias",
        product: "Consultoria Pro",
        value: "R$ 4.800,00",
        tag: { label: "Frio", tone: "primary" },
        owner: { name: "Admin EduIT", initials: "AE", online: true },
        accent: "amber",
      },
      {
        ...
        ref: "#35",
        date: "18/04/2026",
        contact: "Gabriela Souza",
        initials: "GS",
        channel: "whatsapp",
        title: "Programa de Liderança",
        age: "20 dias",
        product: "Mentoria Executiva",
        value: "R$ 8.800,00",
        tag: { label: "Quente", tone: "amber" },
        owner: { name: "Admin EduIT", initials: "AE" },
        accent: "amber",
      },
    ],
  },
    ...
    cards: [
      {
        ...
        initials: "KT",
        channel: "whatsapp",
        title: "Mentoria VIP — Karina",
        age: "4d",
        product: "Coaching Premium",
        value: "R$ 3.200,00",
        tag: { label: "Frio", tone: "primary" },
        owner: { name: "Admin EduIT", initials: "AE" },
        accent: "primary",
    ...
    cards: [
      {
        ...
        ref: "#2",
        date: "04/04/2026",
        contact: "Marcílio Dias",
        initials: "MD",
        channel: "whatsapp",
        title: "Site — EduIT New",
        age: "20 dias",
        product: "Administração EAD",
        value: "R$ 119,00",
        tag: { label: "Indicação", tone: "primary" },
        owner: { name: "Admin EduIT", initials: "AE", online: true },
        accent: "destructive",
      },
      {
        ...
        ref: "#36",
        date: "18/04/2026",
        contact: "Fábio Ribeiro",
        initials: "FR",
        channel: "whatsapp",
        title: "Parceria de Revenda",
        age: "20 dias",
        product: "Plano White Label",
        value: "R$ 18.500,00",
        tag: { label: "Parceiro", tone: "success" },
        owner: { name: "Admin EduIT", initials: "AE", online: true },
        accent: "destructive",
      },
      {
        ...
        ref: "#37",
        date: "18/04/2026",
        contact: "Leonardo Mello",
        initials: "LM",
        channel: "whatsapp",
        title: "Bootcamp de Dados",
        age: "20 dias",
        product: "Treinamento Corporativo",
        value: "R$ 8.990,00",
        tag: { label: "Quente", tone: "amber" },
        owner: { name: "Admin EduIT", initials: "AE" },
        accent: "destructive",
    ...
    cards: [
      {
        ...
        ref: "#41",
        date: "12/04/2026",
        contact: "Aurora Capital",
        initials: "AC",
        channel: "email",
        title: "Plano Enterprise anual",
        age: "8 dias",
        product: "Suite Completa",
        value: "R$ 32.000,00",
        tag: { label: "Ganho", tone: "success" },
        owner: { name: "Admin EduIT", initials: "AE", online: true },
        accent: "success",
      },
      {
